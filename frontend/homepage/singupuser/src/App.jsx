    ...
    <div className='flex flex-col w-screen m-auto h-screen font-quicksand overflow-x-hidden'>
      <div className='flex w-screen'>
        ...
        <div className='flex flex-col gap-5 ml-12'>
          <p className='font-bold text-3xl mt-4'>Sing up</p>
          <input
          ...
          className='h-10  p-4 border-2 rounded-sm w-80 ml-24'  
            ...
            onChange={handlePasswordChange}
          />
          <button className='w-44 bg-orange-400 hover:bg-orange-300 text-white font-bold ml-40 ' >Sing up</button>
          <img className='mr-10' src="./elements/fassel.svg" alt="" />
        </div>
        <GoogleLoginButton />

        <p className='ml-10 mt-10'>you  have an account? <a href="">Login</a></p>
      </div>
