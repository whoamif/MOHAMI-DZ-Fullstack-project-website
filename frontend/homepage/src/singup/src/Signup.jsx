  ...
  return (
    <>
      <div className='flex flex-col  w-screen m-auto h-screen font-quicksand'>
        ...
        <div className='flex flex-col gap-8 bg-white-500 w-1/2 pt-32 items-start pl-12'>
        ...
        <div className='bg-cover bg-center w-1/2' style={{ backgroundImage: {pic}, height: '100%' }}>
        </div>
        </div>
